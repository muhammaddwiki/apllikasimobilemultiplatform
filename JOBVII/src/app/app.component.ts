...
// Here you can do any higher level native things you mightneed.
        statusBar.styleDefault();
            ...
            FCMPlugin.onTokenRefresh(function (token) {
                ...
                //Notification was received in foreground. Maybe the user needs tobe notified.
                alert(JSON.stringify(data));
                }
                });
                ...
                FCMPlugin.createNotificationChannelAndroid({
                   ...
                   name: "Urgent_Alert", //required
                   description: "very urgent message alert",
                   importance : "high",
                   //https://developer.android.com/guide/topics/ui/notifiers/notifications#importnce
                   visibility: "public",
                   //https://developer.android.com/training/notify-user/buildnotification#lockscreenNotification
                   sound: "alert_sound",
                   // In the "alert_sound" example, the file shouldlocated as resources/raw/alert_sound.mp3
